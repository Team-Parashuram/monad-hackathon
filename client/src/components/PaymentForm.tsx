        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              className="w-full px-5 py-4 pr-12 sm:px-6 sm:py-4 sm:pr-14 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-orange-500 dark:focus:ring-yellow-500 text-sm sm:text-base appearance-none"
            >
